...
"}"));
    ...
    void retranslateUi(QDialog *programme)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("programme", "Afficher", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("programme", "Ajouter", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("programme", "Modifier", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("programme", "Supprimer", Q_NULLPTR));
    } // retranslateUi
